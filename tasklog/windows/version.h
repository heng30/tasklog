...
#define PRODUCT_NAME "tasklog"  // 产品名称
...
#define INTERNAL_NAME "tasklog.exe"
#define FILE_DESCRIPTION                                                       \
  "It's a dead simple task track application.（这是一个极简的任务追踪软件）" // 文件说明
#define LEGAL_COPYRIGHT                                                        \
  "Copyright 2023-2033 The Heng30 Company Ltd. All rights reserved." // 版权
#define ORIGINAL_FILE_NAME "tasklog.exe"         // 原始文件名
